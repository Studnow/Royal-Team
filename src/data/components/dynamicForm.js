...
export default {
  ...
  action: "/send-contact",
  method: "post",
  formClass: "flex flex-col md:flex-row",
  containerClass: "flex flex-col md:flex-row flex-wrap gap-2",
  ...
  */
  fields: [
    ...
    /* button rendered via partial; create a props object so the partial receives expected keys */
    {
      ...
      props: Object.assign({}, button, { text: "Отправить", btnType: "submit", class: "btn btn-primary" }),
    },
  ],
};
