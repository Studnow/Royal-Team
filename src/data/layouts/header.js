...
export default {
  ...
  navbar: {
    ...
    navbarCenter: " flex w-1/2 lg:w-auto justify-center",
    navbarEnd: " w-1/4 lg:w-1/6",
  },
  start: {
    components: [
      logo,
      { ...menu, type: "list-dropdown", dropdownContent: "menu w-80 bg-base-100 lg:hidden rounded-sm" },
    ],
  },
  center: {
